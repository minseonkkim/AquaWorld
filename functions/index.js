...
// ─── Star Coral 구매 (폐기됨) ────────────────────────────────────────────────
//
// Star Coral 은 보상형 광고로만 지급된다(prepareAdReward/claimAdReward). 인앱결제와
// 그 영수증 검증(verifyStarCoralPurchase)은 제거했다 — 되살릴 일이 생기면 새로 쓴다.
// 이 스텁만 남겨 구버전 클라이언트가 호출했을 때 명확한 안내를 돌려준다.
